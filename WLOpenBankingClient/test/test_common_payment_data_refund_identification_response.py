...
class TestCommonPaymentDataRefundIdentificationResponse(unittest.TestCase):
    """CommonPaymentDataRefundIdentificationResponse unit test stubs"""
    ...
    def testCommonPaymentDataRefundIdentificationResponse(self):
        """Test CommonPaymentDataRefundIdentificationResponse"""
        # FIXME: construct object with mandatory attributes with example values
        # model = swagger_client.models.common_payment_data_refund_identification_response.CommonPaymentDataRefundIdentificationResponse()  # noqa: E501
