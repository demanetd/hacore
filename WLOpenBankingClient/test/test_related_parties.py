...
class TestRelatedParties(unittest.TestCase):
    """RelatedParties unit test stubs"""
    ...
    def testRelatedParties(self):
        """Test RelatedParties"""
        # FIXME: construct object with mandatory attributes with example values
        # model = swagger_client.models.related_parties.RelatedParties()  # noqa: E501
