...
class TestCommonPaymentDataRefundConfirmationResponse(unittest.TestCase):
    """CommonPaymentDataRefundConfirmationResponse unit test stubs"""
    ...
    def testCommonPaymentDataRefundConfirmationResponse(self):
        """Test CommonPaymentDataRefundConfirmationResponse"""
        # FIXME: construct object with mandatory attributes with example values
        # model = swagger_client.models.common_payment_data_refund_confirmation_response.CommonPaymentDataRefundConfirmationResponse()  # noqa: E501
