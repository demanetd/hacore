...
class TestAccountItemLink(unittest.TestCase):
    """AccountItemLink unit test stubs"""
    ...
    def testAccountItemLink(self):
        """Test AccountItemLink"""
        # FIXME: construct object with mandatory attributes with example values
        # model = swagger_client.models.account_item_link.AccountItemLink()  # noqa: E501
