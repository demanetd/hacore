...
body = swagger_client.ConsentRequest()
body.permissions = [PermissionEnum.ACCOUNTS, PermissionEnum.BALANCES, PermissionEnum.TRANSACTIONS]
body.psu_data = swagger_client.PsuData()
...
try:
    ...
    api_response = api_instance.consent_extended(xreqid, datetime.datetime.now(), psuid, body = body)
