...
class TestMerchantDetail(unittest.TestCase):
    """MerchantDetail unit test stubs"""
    ...
    def testMerchantDetail(self):
        """Test MerchantDetail"""
        # FIXME: construct object with mandatory attributes with example values
        # model = swagger_client.models.merchant_detail.MerchantDetail()  # noqa: E501
