...
class TestPsuCredentials(unittest.TestCase):
    """PsuCredentials unit test stubs"""
    ...
    def testPsuCredentials(self):
        """Test PsuCredentials"""
        # FIXME: construct object with mandatory attributes with example values
        # model = swagger_client.models.psu_credentials.PsuCredentials()  # noqa: E501
