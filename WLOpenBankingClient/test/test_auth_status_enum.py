...
class TestAuthStatusEnum(unittest.TestCase):
    """AuthStatusEnum unit test stubs"""
    ...
    def testAuthStatusEnum(self):
        """Test AuthStatusEnum"""
        # FIXME: construct object with mandatory attributes with example values
        # model = swagger_client.models.auth_status_enum.AuthStatusEnum()  # noqa: E501
