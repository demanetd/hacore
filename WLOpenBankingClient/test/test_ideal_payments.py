...
class TestIDEALPayments(unittest.TestCase):
    """IDEALPayments unit test stubs"""
    ...
    def testIDEALPayments(self):
        """Test IDEALPayments"""
        # FIXME: construct object with mandatory attributes with example values
        # model = swagger_client.models.ideal_payments.IDEALPayments()  # noqa: E501
