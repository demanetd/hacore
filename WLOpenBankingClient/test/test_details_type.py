...
class TestDetailsType(unittest.TestCase):
    """DetailsType unit test stubs"""
    ...
    def testDetailsType(self):
        """Test DetailsType"""
        # FIXME: construct object with mandatory attributes with example values
        # model = swagger_client.models.details_type.DetailsType()  # noqa: E501
