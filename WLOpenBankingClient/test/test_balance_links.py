...
class TestBalanceLinks(unittest.TestCase):
    """BalanceLinks unit test stubs"""
    ...
    def testBalanceLinks(self):
        """Test BalanceLinks"""
        # FIXME: construct object with mandatory attributes with example values
        # model = swagger_client.models.balance_links.BalanceLinks()  # noqa: E501
