...
class TestCommonPaymentDataRefundAuthorisationResponse(unittest.TestCase):
    """CommonPaymentDataRefundAuthorisationResponse unit test stubs"""
    ...
    def testCommonPaymentDataRefundAuthorisationResponse(self):
        """Test CommonPaymentDataRefundAuthorisationResponse"""
        # FIXME: construct object with mandatory attributes with example values
        # model = swagger_client.models.common_payment_data_refund_authorisation_response.CommonPaymentDataRefundAuthorisationResponse()  # noqa: E501
