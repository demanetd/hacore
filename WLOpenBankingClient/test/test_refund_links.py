...
class TestRefundLinks(unittest.TestCase):
    """RefundLinks unit test stubs"""
    ...
    def testRefundLinks(self):
        """Test RefundLinks"""
        # FIXME: construct object with mandatory attributes with example values
        # model = swagger_client.models.refund_links.RefundLinks()  # noqa: E501
