...
class CredentialDetails(object):
    ...
    def credential_id(self):
        ...
        Credential detail identification of the PSU credential at the bank (provided by CBI if approach is Embedded). If not provided by the ASPSP, then default values should be, * ewl-user-id, when IsSecret=false * ewl-password, when IsSecret=true   # noqa: E501
