...
class ConsentIdentificationRequest(object):
    ...
    def __init__(self, psu_data=None):  # noqa: E501
        """ConsentIdentificationRequest - a model defined in Swagger"""  # noqa: E501
        self._psu_data = None
    ...
    @property
    def psu_data(self):
        """Gets the psu_data of this ConsentIdentificationRequest.  # noqa: E501


        :return: The psu_data of this ConsentIdentificationRequest.  # noqa: E501
    ...
    def psu_data(self, psu_data):
        """Sets the psu_data of this ConsentIdentificationRequest.


        :param psu_data: The psu_data of this ConsentIdentificationRequest.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConsentIdentificationRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConsentIdentificationRequest):
            return False
