...
class ReachDirectoryApi(object):
    ...
    def reach(self, x_request_id, message_create_date_time, service, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            return self.reach_with_http_info(
                x_request_id, message_create_date_time, service, **kwargs
            )  # noqa: E501
        else:
            (data) = self.reach_with_http_info(
                x_request_id, message_create_date_time, service, **kwargs
            )  # noqa: E501
            return data

    def reach_with_http_info(
        self, x_request_id, message_create_date_time, service, **kwargs
    ):  # noqa: E501
        """Get list of ASPSPs reachable with our Open Banking Services  # noqa: E501
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'" " to method reach" % key
                )
            params[key] = val
        del params["kwargs"]
        ...
        if "x_request_id" not in params or params["x_request_id"] is None:
            raise ValueError(
                "Missing the required parameter `x_request_id` when calling `reach`"
            )  # noqa: E501
        ...
        if (
            ...
            raise ValueError(
                "Missing the required parameter `message_create_date_time` when calling `reach`"
            )  # noqa: E501
        # verify the required parameter 'service' is set
        if "service" not in params or params["service"] is None:
            raise ValueError(
                "Missing the required parameter `service` when calling `reach`"
            )  # noqa: E501
        ...
        if "all_aspsp_specific_fields" in params:
            query_params.append(
                ("allAspspSpecificFields", params["all_aspsp_specific_fields"])
            )  # noqa: E501
