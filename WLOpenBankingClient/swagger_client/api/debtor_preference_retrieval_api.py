...
class DebtorPreferenceRetrievalApi:
    ...
    def get_all_psu_banks_with_accounts(self, psuid, x_request_id, message_create_date_time, aspsp_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_all_psu_banks_with_accounts(psuid, x_request_id, message_create_date_time, aspsp_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_all_psu_banks_with_accounts_with_http_info(psuid, x_request_id, message_create_date_time, aspsp_id, **kwargs)  # noqa: E501
        (data) = self.get_all_psu_banks_with_accounts_with_http_info(psuid, x_request_id, message_create_date_time, aspsp_id, **kwargs)  # noqa: E501
        return data

    def get_all_psu_banks_with_accounts_with_http_info(self, psuid, x_request_id, message_create_date_time, aspsp_id, **kwargs):  # noqa: E501
        """Get PSU preferred bank and preferred account  # noqa: E501

        Currently could be used only for iDEAL 2.0 payments   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_psu_banks_with_accounts_with_http_info(psuid, x_request_id, message_create_date_time, aspsp_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['psuid', 'x_request_id', 'message_create_date_time', 'aspsp_id', 'signature', 'digest', 'initiating_party_sub_id']  # noqa: E501
        ...
        if ('psuid' not in params or
                params['psuid'] is None):
            raise ValueError("Missing the required parameter `psuid` when calling `get_all_psu_banks_with_accounts`")  # noqa: E501
        # verify the required parameter 'x_request_id' is set
        if ('x_request_id' not in params or
                params['x_request_id'] is None):
            raise ValueError("Missing the required parameter `x_request_id` when calling `get_all_psu_banks_with_accounts`")  # noqa: E501
        ...
        if ('message_create_date_time' not in params or
            ...
            raise ValueError("Missing the required parameter `message_create_date_time` when calling `get_all_psu_banks_with_accounts`")  # noqa: E501
        # verify the required parameter 'aspsp_id' is set
        if ('aspsp_id' not in params or
                params['aspsp_id'] is None):
            raise ValueError("Missing the required parameter `aspsp_id` when calling `get_all_psu_banks_with_accounts`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ob/pis/v3/preferences/{Psuid}/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
