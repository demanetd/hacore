...
class PeriodRules:
    ...
    def execution_rule(self, execution_rule):
        ...
        if execution_rule not in allowed_values:
            raise ValueError(
                f"Invalid value for `execution_rule` ({execution_rule}), must be one of {allowed_values}"  # noqa: E501
    ...
    def frequency(self, frequency):
        ...
        if frequency not in allowed_values:
            raise ValueError(
                f"Invalid value for `frequency` ({frequency}), must be one of {allowed_values}"  # noqa: E501
