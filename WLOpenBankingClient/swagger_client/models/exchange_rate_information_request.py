...
class ExchangeRateInformationRequest:
    ...
    def __init__(self, unit_currency=None, exchange_rate=None, rate_type=None, contract_identification=None):  # noqa: E501
        """ExchangeRateInformationRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def unit_currency(self):
        """Gets the unit_currency of this ExchangeRateInformationRequest.  # noqa: E501
        ...
        :return: The unit_currency of this ExchangeRateInformationRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def unit_currency(self, unit_currency):
        """Sets the unit_currency of this ExchangeRateInformationRequest.

        Currency in which the rate of exchange is expressed in a currency exchange. In the example 1GBP = xxxCUR, the unit currency is GBP.   # noqa: E501

        :param unit_currency: The unit_currency of this ExchangeRateInformationRequest.  # noqa: E501
        :type: str
        """
    ...
    def exchange_rate(self):
        """Gets the exchange_rate of this ExchangeRateInformationRequest.  # noqa: E501
        ...
        :return: The exchange_rate of this ExchangeRateInformationRequest.  # noqa: E501
        :rtype: float
        """
    ...
    def exchange_rate(self, exchange_rate):
        """Sets the exchange_rate of this ExchangeRateInformationRequest.

        The factor used for conversion of an amount from one currency to another. This reflects the price at which one currency was bought with another currency. Rate expressed as a decimal, for example, 0.7 is 7/10 and 70%.   # noqa: E501

        :param exchange_rate: The exchange_rate of this ExchangeRateInformationRequest.  # noqa: E501
        :type: float
        """
    ...
    @property
    def rate_type(self):
        """Gets the rate_type of this ExchangeRateInformationRequest.  # noqa: E501
        ...
        :return: The rate_type of this ExchangeRateInformationRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def rate_type(self, rate_type):
        """Sets the rate_type of this ExchangeRateInformationRequest.

        Specifies the type used to complete the currency exchange. * Spot: Exchange rate applied is the spot rate. * Sale: Exchange rate applied is the market rate at the time of the sale. * Agreed: Exchange rate applied is the rate agreed between the parties.   # noqa: E501

        :param rate_type: The rate_type of this ExchangeRateInformationRequest.  # noqa: E501
        :type: str
        """
        allowed_values = ["Spot", "Sale", "Agreed"]  # noqa: E501
        if rate_type not in allowed_values:
            raise ValueError(
                f"Invalid value for `rate_type` ({rate_type}), must be one of {allowed_values}"  # noqa: E501
    ...
    def contract_identification(self):
        """Gets the contract_identification of this ExchangeRateInformationRequest.  # noqa: E501
        ...
        :return: The contract_identification of this ExchangeRateInformationRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def contract_identification(self, contract_identification):
        """Sets the contract_identification of this ExchangeRateInformationRequest.

        Unique and unambiguous reference to the foreign exchange contract agreed between the initiating party/creditor and the debtor agent.   # noqa: E501

        :param contract_identification: The contract_identification of this ExchangeRateInformationRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ExchangeRateInformationRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExchangeRateInformationRequest):
            return False
