...
from swagger_client.models.address_data import AddressData  # noqa: F401,E501


class AllOfRiskInformationDeliveryAddress(AddressData):
    ...
    if hasattr(AddressData, "swagger_types"):
        swagger_types.update(AddressData.swagger_types)

    attribute_map = {
    }
    if hasattr(AddressData, "attribute_map"):
        attribute_map.update(AddressData.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfRiskInformationDeliveryAddress - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfRiskInformationDeliveryAddress, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfRiskInformationDeliveryAddress):
            return False
