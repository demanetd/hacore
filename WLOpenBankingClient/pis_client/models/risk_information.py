...
class RiskInformation(object):
    ...
    def applied_authentication_approach(self, applied_authentication_approach):
        ...
        if applied_authentication_approach not in allowed_values:
            raise ValueError(
                "Invalid value for `applied_authentication_approach` ({0}), must be one of {1}"  # noqa: E501
                .format(applied_authentication_approach, allowed_values)
            )
