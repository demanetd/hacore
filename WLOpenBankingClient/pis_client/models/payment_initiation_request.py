...
class PaymentInitiationRequest(object):
    ...
    swagger_types = {
        ...
        'psu_data': 'PsuData',
        'common_payment_data': 'PaymentInitiationRequestBasic',
    ...
    def __init__(self, payment_product=None, payment_product_changeable=False, product_specific_master_data=None, psu_data=None, common_payment_data=None, ideal_payments=None):  # noqa: E501
        """PaymentInitiationRequest - a model defined in Swagger"""  # noqa: E501
        ...
        if ideal_payments is not None:
            self.ideal_payments = ideal_payments

    @property
    def payment_product(self):
        """Gets the payment_product of this PaymentInitiationRequest.  # noqa: E501

        Multiple PaymentProducts can only be supplied if `UseAuthorisationLandingPages` equals `TRUE`. These will then influence ASPSPs visible to the PSU on the Bank Selection Interface. The IDEAL payment product cannot be mixed with the other PSD2-xxxx payment products, because it requires a separate subscription and therefore uses a different authorization token.   # noqa: E501

        :return: The payment_product of this PaymentInitiationRequest.  # noqa: E501
    ...
    def payment_product(self, payment_product):
        """Sets the payment_product of this PaymentInitiationRequest.

        Multiple PaymentProducts can only be supplied if `UseAuthorisationLandingPages` equals `TRUE`. These will then influence ASPSPs visible to the PSU on the Bank Selection Interface. The IDEAL payment product cannot be mixed with the other PSD2-xxxx payment products, because it requires a separate subscription and therefore uses a different authorization token.   # noqa: E501

        :param payment_product: The payment_product of this PaymentInitiationRequest.  # noqa: E501
    ...
    def payment_product_changeable(self):
        """Gets the payment_product_changeable of this PaymentInitiationRequest.  # noqa: E501
        ...
        :return: The payment_product_changeable of this PaymentInitiationRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def payment_product_changeable(self, payment_product_changeable):
        """Sets the payment_product_changeable of this PaymentInitiationRequest.

        Allowing PSU to change pre-selected payment product if the ASPSP supports more than one from the list provided by the Initiating Party. Usable only if `UseAuthorisationLandingPages` equals `TRUE`. Otherwise will be ignored.   # noqa: E501

        :param payment_product_changeable: The payment_product_changeable of this PaymentInitiationRequest.  # noqa: E501
        :type: bool
        """
    ...
    def product_specific_master_data(self):
        """Gets the product_specific_master_data of this PaymentInitiationRequest.  # noqa: E501

        The array is defined to mention the master data specific to selected payment product   # noqa: E501

        :return: The product_specific_master_data of this PaymentInitiationRequest.  # noqa: E501
    ...
    def product_specific_master_data(self, product_specific_master_data):
        """Sets the product_specific_master_data of this PaymentInitiationRequest.

        The array is defined to mention the master data specific to selected payment product   # noqa: E501

        :param product_specific_master_data: The product_specific_master_data of this PaymentInitiationRequest.  # noqa: E501
    ...
    @property
    def psu_data(self):
        """Gets the psu_data of this PaymentInitiationRequest.  # noqa: E501


        :return: The psu_data of this PaymentInitiationRequest.  # noqa: E501
        :rtype: PsuData
        """
    ...
    def psu_data(self, psu_data):
        """Sets the psu_data of this PaymentInitiationRequest.


        :param psu_data: The psu_data of this PaymentInitiationRequest.  # noqa: E501
        :type: PsuData
        """
    ...
    def common_payment_data(self):
        """Gets the common_payment_data of this PaymentInitiationRequest.  # noqa: E501


        :return: The common_payment_data of this PaymentInitiationRequest.  # noqa: E501
        :rtype: PaymentInitiationRequestBasic
        """
        return self._common_payment_data

    @common_payment_data.setter
    def common_payment_data(self, common_payment_data):
        """Sets the common_payment_data of this PaymentInitiationRequest.


        :param common_payment_data: The common_payment_data of this PaymentInitiationRequest.  # noqa: E501
        :type: PaymentInitiationRequestBasic
        """
    ...
    @property
    def ideal_payments(self):
        """Gets the ideal_payments of this PaymentInitiationRequest.  # noqa: E501


        :return: The ideal_payments of this PaymentInitiationRequest.  # noqa: E501
        :rtype: IDEALPayments
        """
        return self._ideal_payments

    @ideal_payments.setter
    def ideal_payments(self, ideal_payments):
        """Sets the ideal_payments of this PaymentInitiationRequest.


        :param ideal_payments: The ideal_payments of this PaymentInitiationRequest.  # noqa: E501
        :type: IDEALPayments
        """

        self._ideal_payments = ideal_payments
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaymentInitiationRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaymentInitiationRequest):
            return False
