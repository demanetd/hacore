...
class PaymentProductEnum(object):
    ...
    """
    PSD2_SCT = "PSD2-SCT"
    PSD2_SCT_INST = "PSD2-SCT-Inst"
    PSD2_TARGET2 = "PSD2-Target2"
    PSD2_DOMESTIC = "PSD2-Domestic"
    PSD2_DOMESTIC_INST = "PSD2-Domestic-Inst"
    IDEAL = "IDEAL"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """PaymentProductEnum - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PaymentProductEnum, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaymentProductEnum):
            return False
