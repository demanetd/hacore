...
class PaymentStatusEnum(object):
    ...
    PENDING = "Pending"
    SETTLEMENTINPROCESS = "SettlementInProcess"
    SETTLEMENTCOMPLETED = "SettlementCompleted"
    RECEIVEDBYCREDITORBANK = "ReceivedByCreditorBank"
    RECEIVEDONCREDITORACCOUNT = "ReceivedOnCreditorAccount"
    CANCELLED = "Cancelled"
    CANCELLEDATTPP = "CancelledAtTPP"
